# 1 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc02_myaccount\\\\combined_JpetStore_SC02_MyAccount.c"
...
# 1 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc02_myaccount\\\\combined_JpetStore_SC02_MyAccount.c" 2
...
# 2 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc02_myaccount\\\\combined_JpetStore_SC02_MyAccount.c" 2
...
# 3 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc02_myaccount\\\\combined_JpetStore_SC02_MyAccount.c" 2
...
# 4 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc02_myaccount\\\\combined_JpetStore_SC02_MyAccount.c" 2
...
Action()
{
     ...
     if(atoi(lr_eval_string("{Launchpage}"))>0)
        {
     	 ...
     	 lr_end_transaction("JpetStore_SC02_TC01_Launch",0);
        }
        else
        { 
          lr_output_message("invalid responce");
          lr_end_transaction("JpetStore_SC02_TC01_Launch",2);
          lr_abort();
        }
	...
	web_url("Sign In", 
     ...
     if(atoi(lr_eval_string("{signin page}"))>0)
        {
     	 lr_output_message("valid responce");
         lr_end_transaction("JpetStore_SC02_TC02_Signin",0);
        }
        else
        { 
          lr_output_message("invalid responce");
          lr_end_transaction("JpetStore_SC02_TC02_Signin",2);
          lr_abort();
        }
    ...
    if(atoi(lr_eval_string("{login page}"))>0)
        {
     	 lr_output_message("valid responce");
         lr_end_transaction("Jpet_Store_SC02_TC03_Login",0);
        }
        else
        { 
          lr_output_message("invalid responce");
          lr_end_transaction("Jpet_Store_SC02_TC03_Login",2);
          lr_abort();
        }
	...
	if(atoi(lr_eval_string("{my account page}"))>0)
	{
		...
		lr_end_transaction("Jpet_Store_SC02_TC04_My_Account",0);
	}else
	{
		lr_output_message("invalid");
		lr_end_transaction("Jpet_Store_SC02_TC04_My_Account",2);
		lr_abort();
	}
	...
	{
		lr_output_message("valid");
		lr_end_transaction("Jpet_Store_SC02_TC05_Click_On_MyOrder",0);
	}else
	{
		lr_output_message("invalid");
		lr_end_transaction("Jpet_Store_SC02_TC05_Click_On_MyOrder",2);
		lr_abort();
	}
	...
	{
		lr_output_message("valid");
	    lr_end_transaction("Jpet_Store_SC02_TC06_Sign_Out",0);
	}else
	{
		lr_output_message("invalid");
	    lr_end_transaction("Jpet_Store_SC02_TC06_Sign_Out",2);
		lr_abort();
	}
...
# 5 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc02_myaccount\\\\combined_JpetStore_SC02_MyAccount.c" 2
...
# 6 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc02_myaccount\\\\combined_JpetStore_SC02_MyAccount.c" 2
