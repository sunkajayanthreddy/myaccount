Action()
{
   lr_start_transaction("Jpet_Store_SC02_TC01_Launch");
    ...
    lr_end_transaction("Jpet_Store_SC02_TC01_Launch",LR_AUTO);
    
	lr_think_time(4);

	lr_start_transaction("Jpet_Store_SC02_TC02_Sign_In");
	...
	lr_end_transaction("Jpet_Store_SC02_TC02_Sign_In",LR_AUTO);
	...
	lr_start_transaction("Jpet_Store_SC02_TC05_Click_On_My_Order");
	...
	lr_end_transaction("Jpet_Store_SC02_TC05_Click_On_My_Order",LR_AUTO);

	lr_think_time(5);
	
	lr_start_transaction("Jpet_Store_SC02_TC06_Click_On_Order_ID");
	...
	lr_end_transaction("Jpet_Store_SC02_TC06_Click_On_Order_ID",LR_AUTO);
	
	lr_think_time(5);

	lr_start_transaction("Jpet_Store_SC02_TC07_Sign_Out");
	...
	web_url("Sign Out", 
		...
		lr_end_transaction("Jpet_Store_SC02_TC07_Sign_Out",LR_AUTO);
